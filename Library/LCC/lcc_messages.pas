...
private
  ...
  function GetDataArrayIndexer(iIndex: Word): Byte;
...
function TLccMessage.GetDataArrayIndexer(iIndex: Word): Byte;
begin
...
procedure TLccMessage.SetDataArrayIndexer(iIndex: Word; const Value: Byte);
begin

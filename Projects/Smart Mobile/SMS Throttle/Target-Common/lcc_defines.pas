...
const
  ...
  // Bit 3-4 options
  TRACTION_SEARCH_TRACK_PROTOCOL_GROUP_ALL             = $0000; // b00000000
  TRACTION_SEARCH_TRACK_PROTOCOL_GROUP_DCC             = $0008; // b00001000
  TRACTION_SEARCH_TRACK_PROTOCOL_GROUP_RESERVED_1      = $0100; // b00010000
  TRACTION_SEARCH_TRACK_PROTOCOL_GROUP_RESERVED_2      = $0018; // b00011000

  // Bit 2 options
  TRACTION_SEARCH_TRACK_PROTOCOL_DCC_ADDRESS_DEFAULT    = $0000; // b00000000 valid with TRACTION_SEARCH_TRACK_PROTOCOL_GROUP_DCC only
  TRACTION_SEARCH_TRACK_PROTOCOL_DCC_ADDRESS_LONG       = $0004; // b00000100 valid with TRACTION_SEARCH_TRACK_PROTOCOL_GROUP_DCC only
  TRACTION_SEARCH_TRACK_PROTOCOL_NON_MARKLIN            = $0000; // b00000000 valid with TRACTION_SEARCH_TRACK_PROTOCOL_GROUP_ALL only
  TRACTION_SEARCH_TRACK_PROTOCOL_MARKLIN                = $0004; // b00000100 valid with TRACTION_SEARCH_TRACK_PROTOCOL_GROUP_ALL only

  // Bit 0-1
  // valid with TRACTION_SEARCH_TRACK_PROTOCOL_GROUP_ALL and TRACTION_SEARCH_TRACK_PROTOCOL_NON_MARKLIN only
  TRACTION_SEARCH_TRACK_PROTOCOL_ALL                    = $0000; // b00000000
  TRACTION_SEARCH_TRACK_PROTOCOL_NATIVE_OPENLCB         = $0001; // b00000000
  TRACTION_SEARCH_TRACK_PROTOCOL_MFX_M4                 = $0002; // b00000010
  TRACTION_SEARCH_TRACK_PROTOCOL_RESERVED_1             = $0003; // b00000011

  // valid with TRACTION_SEARCH_TRACK_PROTOCOL_GROUP_ALL and TRACTION_SEARCH_TRACK_PROTOCOL_MARKLIN only
  TRACTION_SEARCH_TRACK_PROTOCOL_MARKLIN_ANY            = $0000; // b00000000
  TRACTION_SEARCH_TRACK_PROTOCOL_MARKLIN_VERSION_1      = $0001; // b00000001
  TRACTION_SEARCH_TRACK_PROTOCOL_MARKLIN_VERSION_2      = $0002; // b00000010
  TRACTION_SEARCH_TRACK_PROTOCOL_MARKLIN_VERSION_2_F8   = $0003; // b00000011

  // valid with TRACTION_SEARCH_TRACK_PROTOCOL_GROUP_DCC
  TRACTION_SEARCH_TRACK_PROTOCOL_DCC_ANY_SPEED_STEP     = $0000; // b00000000
  TRACTION_SEARCH_TRACK_PROTOCOL_DCC_14_SPEED_STEP      = $0001; // b00000001
  TRACTION_SEARCH_TRACK_PROTOCOL_DCC_28_SPEED_STEP      = $0002; // b00000010
  TRACTION_SEARCH_TRACK_PROTOCOL_DCC_128_SPEED_STEP     = $0003; // b00000011

  // Bit 7
  TRACTION_SEARCH_ALLOCATE_FORCE                        = $0080; // b10000000
  TRACTION_SEARCH_ALLOCATE_EXISTING_ONLY                = $0000; // b00000000

  // Bit 6
  TRACTION_SEARCH_TYPE_EXACT_MATCH                      = $0040; // b01000000
  TRACTION_SEARCH_TYPE_ALL_MATCH                        = $0000; // b00000000

  // Bit 5
  TRACTION_SEARCH_TARGET_ADDRESS_MATCH                  = $0020; // b00100000
  TRACTION_SEARCH_TARGET_ANY_MATCH                      = $0000; // b00000000

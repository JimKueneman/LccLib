...
const
  ...
  // Bit 3-4 options
  TRACTION_SEARCH_TRACK_PROTOCOL_GROUP_ANY             = $0000; // b00000000
  TRACTION_SEARCH_TRACK_PROTOCOL_GROUP_DCC_ONLY        = $0008; // b00001000
  ...
  // Bit 2 options
  TRACTION_SEARCH_TRACK_PROTOCOL_DCC_ADDRESS_DEFAULT    = $0000; // b00000000 valid with TRACTION_SEARCH_TRACK_PROTOCOL_GROUP_DCC_ONLY only
  TRACTION_SEARCH_TRACK_PROTOCOL_DCC_ADDRESS_LONG       = $0004; // b00000100 valid with TRACTION_SEARCH_TRACK_PROTOCOL_GROUP_DCC_ONLY only
  TRACTION_SEARCH_TRACK_PROTOCOL_NON_MARKLIN            = $0000; // b00000000 valid with TRACTION_SEARCH_TRACK_PROTOCOL_GROUP_ANY only
  TRACTION_SEARCH_TRACK_PROTOCOL_MARKLIN                = $0004; // b00000100 valid with TRACTION_SEARCH_TRACK_PROTOCOL_GROUP_ANY only
